    ...
    <div class="row">
        ...
        <div class="col-xl-12">
            <div class="card mg-b-20">
                ...
                <div class="card-body">
                    <div class="">
                        <table id="example1" class="table  key-buttons mg-b-0">
                            <thead>
                                <tr>
                            ...
                            <tbody>
                                ...
                                @foreach ($products as $i)
                                    ...
                                    <tr>
                                        ...
                                        <td>{{ $i->sections->section_name }}</td>
										<td>{{ $i->description }}</td>
                                        <td>
                                            <a class="modal-effect btn btn-sm btn-info" data-effect="effect-scale"
                                                data-id="{{ $i->id }}"
												data-product_name="{{ $i->Product_name }}"
												data-section_name="{{ $i->sections->section_name }}"
                ...
                <div class="modal-body">
                    <form action="products/update" method="post" autocomplete="off">
                        ...
                        <select name="section_name" id="section_name" class="form-control" required>
                            {{-- <option value="" selected disabled> --حدد القسم--</option> --}}
                            @foreach ($sections as $section)
                                <option>{{ $section->section_name }}</option>{{--value="{{ $section->id }}"--}}
                            @endforeach
                        </select>
